...
let massage2 = "Comfort is the worst addiction";
...
// Exercise no 11
let names = ["Sana", "Hina", "Soni", "Tehmina"];
names.forEach(name => {
    console.log(name);
});
// Exercise no 12
let massage3 = "you ar my friend.";
names.forEach(name => {
    console.log(`Hello ${name} ${massage3}`);
});
// Exercise 13
let transportation = ["car", " motorcycle ", "cycle"];
transportation.forEach(transport => {
    console.log(` “I would like to own a ${transport}`);
});
// Exercise no 14
let GuestList = ["Sana", "Hina", "Aresha"];
...
let notInvited = GuestList.splice(1, 1)[0];
...
// Exercise no 18
let places = ["USA", "UAE", "Pakistan", "Naran", "Maree"];
...
// Exercise no 19
let guests = ["Farhan", "Kashan", "Ayan", "Salman", "Roshan"];
...
// Exercise no 29
let favorite_fruits = ["apples", "bananas", "cherries", "mango", "orange"];
...
// Exercise no 34
let pizzas = ["Tika", "margherita", "vegetable"];
...
console.log(make_album("Artist Three", "The Third Album", 12));
// Exercise no 41
let magicians = ["Sana", "Hina", "Manahil"];
...
// Exercise no 43
let magicians_2 = ["Sana", "Dia", "Manahil"];
